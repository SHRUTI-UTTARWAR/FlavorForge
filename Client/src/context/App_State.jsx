...
const App_State = (props) => {
  ...
  const profile = async () =>{
    const api = await axios.get(`${url}/user`, {
     ...
     console.log("This is user profile ",api.data)
  ...
  return (
    <AppContext.Provider value={{login,register,addRecipe,recipe,getRecipeById,savedRecipeById,userRecipe,savedRecipe,user,logOut ,isAuthenticated,setisAuthenticated}}>
      {props.children}
    </AppContext.Provider>
  )
}
